...
Display( )
{
	...
	Pattern->SetUniformVariable("uV1", V1);
	Pattern->SetUniformVariable("uV2", V2);
	Pattern->SetUniformVariable("uC1", C1);
	glColor3f(1., 1., 1.);
	glCallList( BoxList );
	...
	else if (Time < gap * 2.)
	{
		...
		glColor3f(0., 0., 1.);
	glTranslatef(0., Radius - (Radius * yy * 2), 0.);
	glScalef(1. - yy, 1. - yy, 1. - yy);
	if (PlateOn)
